...
import {  Button, Image, Icon, Table, Feed,List } from "semantic-ui-react";
...
<div style={{marginBottom:10, marginTop:10}}><h1 style={{color:'#2185d0'}}>Messenger</h1></div>
...
<List.Header>Key: </List.Header>
    ...
    <Table selectable celled='internally'>
    <Table.Header>
      <Table.Row>
